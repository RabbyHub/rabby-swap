...
export const AkkaRouterABI = [
  {
    inputs: [
      ...
      { name: 'quoterV3Address_', internalType: 'address', type: 'address' },
      { name: 'routerV3Address_', internalType: 'address', type: 'address' },
      { name: 'swapsicleRouterAddress_', internalType: 'address', type: 'address' },
      { name: 'izumiRouterAddress_', internalType: 'address', type: 'address' },
      { name: 'feeSigner_', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  { inputs: [{ name: 'owner', internalType: 'address', type: 'address' }], name: 'OwnableInvalidOwner', type: 'error' },
  {
  ...
  {
    inputs: [
      { indexed: true, name: '_from', internalType: 'address', type: 'address' },
      { indexed: false, name: 'tokenIn', internalType: 'address', type: 'address' },
      { indexed: false, name: 'tokenOut', internalType: 'address', type: 'address' },
      { indexed: false, name: 'amountIn', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    outputs: [{ name: '', internalType: 'address', type: 'address' }],
    inputs: [],
    name: 'getSwapsicleRouterAddress',
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    inputs: [
      ...
      { name: 'amountOutMin', internalType: 'uint256', type: 'uint256' },
      {
        components: [
          ...
          { name: 'dstMinAmount', internalType: 'uint256', type: 'uint256' },
          { name: 'isFromNative', internalType: 'uint256', type: 'uint256' },
          { name: 'isToNative', internalType: 'uint256', type: 'uint256' },
          {
            components: [
              { name: 'srcToken', internalType: 'address', type: 'address' },
              { name: 'dstToken', internalType: 'address', type: 'address' },
              { name: 'pairAddr', internalType: 'address', type: 'address' },
              { name: 'fee', internalType: 'uint256', type: 'uint256' },
              { name: 'srcAmount', internalType: 'uint256', type: 'uint256' },
              { name: 'dstMinAmount', internalType: 'uint256', type: 'uint256' },
              { name: 'feeSrc', internalType: 'uint256', type: 'uint256' },
              { name: 'feeDst', internalType: 'uint256', type: 'uint256' },
              { name: 'liquidityType', internalType: 'uint256', type: 'uint256' },
            ],
            name: 'paths',
  ...
  { outputs: [], inputs: [], name: 'renounceOwnership', stateMutability: 'nonpayable', type: 'function' },
  {
    outputs: [],
    inputs: [{ name: '_feeSigner', internalType: 'address', type: 'address' }],
    name: 'setFeeSigner',
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    outputs: [],
    inputs: [{ name: '_izumiRouterAddress', internalType: 'address', type: 'address' }],
    name: 'setIzumiRouterAddress',
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    outputs: [],
    inputs: [{ name: '_quoterV3Address', internalType: 'address', type: 'address' }],
  ...
  {
    outputs: [],
    inputs: [{ name: '_receiverContract', internalType: 'address', type: 'address' }],
  ...
  {
    outputs: [],
    inputs: [{ name: '_routerV3Address', internalType: 'address', type: 'address' }],
  ...
  {
    outputs: [],
    inputs: [{ name: '_swapsicleRouterAddress', internalType: 'address', type: 'address' }],
    name: 'setSwapsicleRouterAddress',
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
